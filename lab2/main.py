...
class Ui_MainWindow(object):
    ...
    def onSendBytes(self):
        ...
        for cadr in cadres:
            # флаг, dest_address и fcs по условию константные
            flag: str = '00010010'
            ...
            # делаешь битстаффинг для очередной строки и добавляешь к строке для отправки
            data_to_send += flag + bitstaffing.bit_staffing(dest_address + source_address + data + fcs)
    ...
    def onRecieveBytes(self):
        ...
        if len(text) == 0:
            ...
            for cadr in cadres:
                ...
                destaffed_cadr: str = bitstaffing.de_bit_staffing(cadr)[8:26:1]
